...
function Landing() {
  return (
    <div>
      ...
      {/* product */}
      <div className="small-screen-adjust">
        <div className="top-space">
          ...
          <div className="text-block ">
            ...
            <div className="text-block-content ">
              ...
              que brindan nuestros productos. Continuamente evolucionamos con
              las tendencias mundiales de la biotecnología y avances
              tecnológicos.
            </div>
          </div>
          ...
          <div className="text-block ">
            ...
            <div className="text-block-content">
              ...
              Nuestros productos son elaborados pensando en el bienestar y
              futuro de la comunidad y el medio ambiente. Solo ingredientes
              naturales, sin conservantes sintéticos, sin agentes espumantes.
              Trabajamos con las 5 R de Sustenatabilidad: reducir, reparar,
              recuperar, reutilizar y reciclar. Libre de crueldad animal
            </div>
          </div>
        </div>
      </div>
